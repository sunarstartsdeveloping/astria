...
const GlowCard: React.FC<GlowCardProps> = ({
  ...
  const getInlineStyles = (): React.CSSProperties & Record<string, string | number> => {
    const baseStyles: Record<string, string | number> = {
      ...
      "--backup-border": "var(--border, rgba(255,255,255,0.1))",
      "--size": "260",
      "--outer": "1",
      ...
      backgroundColor: "var(--card, #0E130F)",
      backgroundSize:
  ...
  return (
    <>
      ...
      <div
        ...
        className={`
          ${getSizeClasses()}
          ${!customSize ? "aspect-[3/4] rounded-2xl grid grid-rows-[1fr_auto] p-4 gap-4" : "relative"}
          backdrop-blur-[5px]
          ${className}
        `}
      >
